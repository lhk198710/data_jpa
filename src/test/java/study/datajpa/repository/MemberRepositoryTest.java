...
class MemberRepositoryTest {
    ...
    public void returnType() {
        ...
        System.err.println("findMember = " + findMember.get());
    }
    ...
    public void slice() {
        ...
        Page<MemberDto> toMap = page.map(m -> new MemberDto(m.getId(), m.getUsername(), null)); // Dto convert. Dto로 변환 시켜서  API 반환 할 것.
        ...
        System.err.println("totalElements = " + totalElements);
